...
- **桌面 MVP 11a**：窗口 chrome、Quick Query、文件拖入 SQLCipher 离线队列、WebView drop、工作站配置/配置档 CRUD、PrivacyContext 对齐、远控 host safe-probe 控制面已有代码/浏览器/本地门禁证据；仍缺 signed packaged runtime、macOS/Windows 截图/视频、快捷键 P95 < 200ms、托盘 drop P95 < 500ms、真实 local model、真实 approved connector 和真机远控证据。
