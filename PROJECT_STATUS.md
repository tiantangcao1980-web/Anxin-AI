...
- 移动真实 iOS/Android（Expo Application Services build + 商店上架）
- 跨端连续会话真机
...
- 后续为商业交付收口：支付/电签真实沙箱、桌面 signed runtime、跨模式/跨设备数据同步、企业 Agent 治理 runtime、移动端 Expo 真机 + 小程序 Taro 体验版发布链路
