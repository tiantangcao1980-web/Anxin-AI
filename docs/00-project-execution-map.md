...
| 用途 | 权威文件 | 作用 |
|---|---|---|
| **产品蓝图（最新）** | `docs/plans/2026-05-22-product-blueprint.md` | 2026-05-22 蓝图：桌面+移动主战场、Web 官网、3 云服务 |
| **实施方案（最新）** | `docs/plans/2026-05-22-implementation-plan.md` | 6 个 lane × 3 周里程碑 |
| **云服务对外契约** | `docs/openspec/03-cloud-services-contract.md` | Auth / Sync / IM 三个核心域端点 + 协议 |
| **设计规范** | `DESIGN.md`（§10 飞书对标） + `docs/design/tokens.md` | 单一 token contract（所有端） |
