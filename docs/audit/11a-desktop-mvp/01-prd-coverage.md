...
| P0-6 desktop workstation entry | Code/browser-level implemented; real connector runtime open | `frontend/src/components/desktop/DesktopWorkstationPanel.tsx`, `desktopWorkstationModel.ts`, `frontend/e2e/settings-workstation.spec.ts`, LLM/knowledge/MCP probe wrappers |
