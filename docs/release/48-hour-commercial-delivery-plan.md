...
| 可信会话与进化治理 | 2026-05-08 OpenSpec 已补 Codex/Claude 式过程可见、artifact-first、可打断/恢复、能力可发现体验，并把 Skills 进化和 agent 自我改进纳入评测/审批/回滚治理 | 48 小时内只冻结规范和任务口径；真实交付需补长任务事件流、artifact 编辑、跨设备恢复、Skill eval gate、审批和回滚证据 |
