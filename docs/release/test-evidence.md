...
# approval authorization guards 7 passed; MCP connection config policy 7 passed; approved connector local rehearsal 1 passed; cross-process revocation local rehearsal 1 passed; desktop remote-control host 8 passed;
