...
| Full capability center UI beyond the current role-filtered visibility panel, Agent approval panel, and Skill governance panel, plus organization policy CRUD, subscription purchase linkage, and department request flow | pending | TBD |
