...
- 移动端和小程序真机覆盖登录、审批、消息/任务详情、会话延续、错误态；本地 fake fallback guard 和 iOS Simulator Expo Go app-run 已过，但真实/官方 iOS、Android、交互式微信开发者工具、跨设备和桌面远控证据仍需补齐。2026-05-09 起新功能按 uni-app 统一端推进，旧 Expo/Taro 端只做安全修复和迁移提取，删除必须等 uni-app 同等能力、测试和真机/DevTools 证据补齐。
