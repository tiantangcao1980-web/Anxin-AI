...
# mobile: 7 files / 19 tests passed; mobile tsc exit 0; Expo doctor 17/17; mobile npm audit exit 0; mini-program tsc/build exit 0; WeChat DevTools CLI project smoke exit 0; refresh-auth/mobile+mini privacy/fake-fallback/design-token guards exit 0
...
bash scripts/mobile-device-smoke.sh
# mobile Vitest 7 files / 19 tests passed; mobile tsc exit 0; Expo doctor 17/17; mobile npm audit exit 0; mini-program tsc/build exit 0; WeChat DevTools CLI project smoke exit 0; refresh-auth/mobile+mini privacy/fake-fallback/design-token guards exit 0
