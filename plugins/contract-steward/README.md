...
`contract-steward` 是 [安心智能助手](../../README.md) 的 Persona 插件之一，提供 *合同全生命周期* 能力。本插件已在 V3 主干注册到 `backend/src/agents/personas/registry.py`，可在桌面端 / Web / 飞书 / 钉钉同步调用。
...
| 命令 | 说明 |
|---|---|
| `/contract-steward:contract-review` | contract-review skill |
| `/contract-steward:contract-draft` | contract-draft skill |
| `/contract-steward:amendment-history` | amendment-history skill |
| `/contract-steward:renewal-flag` | renewal-flag skill |
| `/contract-steward:cold-start-interview` | 首次冷启动访谈，生成执业画像 |
