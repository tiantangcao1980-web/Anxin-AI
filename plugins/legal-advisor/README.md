...
> **法律咨询 / 法规检索 / 风险评估** · 业务域：合规经营

## 这是什么

`legal-advisor` 是 [安心智能助手](../../README.md) 的 Persona 插件之一，提供 *法律咨询 / 法规检索 / 风险评估* 能力。本插件已在 V3 主干注册到 `backend/src/agents/personas/registry.py`，可在桌面端 / Web / 飞书 / 钉钉同步调用。
...
| 命令 | 说明 |
|---|---|
| `/legal-advisor:legal-research` | legal-research skill |
| `/legal-advisor:risk-assessment` | risk-assessment skill |
| `/legal-advisor:regulation-lookup` | regulation-lookup skill |
| `/legal-advisor:case-search` | case-search skill |
| `/legal-advisor:cold-start-interview` | 首次冷启动访谈，生成执业画像 |
