...
> **公众号 / 短视频 / 海报 / 落地页** · 业务域：增长获客

## 这是什么

`content-director` 是 [安心智能助手](../../README.md) 的 Persona 插件之一，提供 *公众号 / 短视频 / 海报 / 落地页* 能力。本插件已在 V3 主干注册到 `backend/src/agents/personas/registry.py`，可在桌面端 / Web / 飞书 / 钉钉同步调用。
...
# 2. 安装本插件
/plugin install content-director@anxin-ai

# 3. 第一次使用前，跑冷启动访谈（生成 CLAUDE.md 执业画像）
/content-director:cold-start-interview
```
...
| 命令 | 说明 |
|---|---|
| `/content-director:wechat-article` | wechat-article skill |
| `/content-director:short-video-script` | short-video-script skill |
| `/content-director:poster-design` | poster-design skill |
| `/content-director:landing-page` | landing-page skill |
| `/content-director:cold-start-interview` | 首次冷启动访谈，生成执业画像 |
