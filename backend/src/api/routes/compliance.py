        ...
        "categories": [
            {
                ...
                "items": [
                    ...
                    {
                        "id": "tech_data_02",
                        "question": "是否建立了数据分级分类制度？",
                        "risk_level": "high",
                        "law_ref": "《数据安全法》第21条",
                    },
                    {
                        "id": "tech_data_03",
                        "question": "是否定期进行数据安全风险评估？",
                        "risk_level": "medium",
                        "law_ref": "《数据安全法》第30条",
                    },
                    {
                        "id": "tech_data_04",
                        "question": "用户数据存储是否在境内？如有出境是否完成安全评估？",
                        "risk_level": "high",
                        "law_ref": "《个人信息保护法》第38条",
                    },
                ],
            },
            {
                ...
                "items": [
                    {
                        "id": "tech_ip_01",
                        "question": "核心技术是否已申请专利或著作权登记？",
                        "risk_level": "medium",
                        "law_ref": "《专利法》《著作权法》",
                    },
                    {
                        "id": "tech_ip_02",
                        "question": "是否与员工签订了知识产权归属协议？",
                        "risk_level": "medium",
                        "law_ref": "《劳动合同法》",
                    },
                    {
                        "id": "tech_ip_03",
                        "question": "是否建立了商业秘密保护制度？",
                        "risk_level": "high",
                        "law_ref": "《反不正当竞争法》第9条",
                    },
                ],
            },
            {
                ...
                "items": [
                    {
                        "id": "tech_labor_01",
                        "question": "是否与全部员工签订书面劳动合同？",
                        "risk_level": "high",
                        "law_ref": "《劳动合同法》第10条",
                    },
                    {
                        "id": "tech_labor_02",
                        "question": "是否按规定缴纳五险一金？",
                        "risk_level": "high",
                        "law_ref": "《社会保险法》第58条",
                    },
                    {
                        "id": "tech_labor_03",
                        "question": "加班制度是否符合法律规定？",
                        "risk_level": "medium",
                        "law_ref": "《劳动法》第36-41条",
                    },
                    {
                        "id": "tech_labor_04",
                        "question": "是否制定了员工手册并依法公示？",
                        "risk_level": "low",
                        "law_ref": "《劳动合同法》第4条",
                    },
                ],
            },
            {
                ...
                "items": [
                    {
                        "id": "tech_contract_01",
                        "question": "重要合同是否经过法务审查？",
                        "risk_level": "high",
                        "law_ref": "《民法典》合同编",
                    },
                    {
                        "id": "tech_contract_02",
                        "question": "合同是否有完整的签署、归档、跟踪流程？",
                        "risk_level": "medium",
                        "law_ref": "企业内控规范",
                    },
                    {
                        "id": "tech_contract_03",
                        "question": "是否定期检查合同到期和续约情况？",
                        "risk_level": "low",
                        "law_ref": "企业内控规范",
                    },
                ],
        ...
        "categories": [
            {
                ...
                "items": [
                    {
                        "id": "mfg_safety_01",
                        "question": "是否取得安全生产许可证？",
                        "risk_level": "high",
                        "law_ref": "《安全生产法》第62条",
                    },
                    {
                        "id": "mfg_safety_02",
                        "question": "是否定期开展安全生产培训？",
                        "risk_level": "high",
                        "law_ref": "《安全生产法》第28条",
                    },
                    {
                        "id": "mfg_safety_03",
                        "question": "是否制定了应急预案并定期演练？",
                        "risk_level": "medium",
                        "law_ref": "《安全生产法》第78条",
                    },
                ],
        ...
        "categories": [
            {
                ...
                "items": [
                    ...
                    {
                        "id": "ret_consumer_02",
                        "question": "是否建立了完善的退换货制度？",
                        "risk_level": "high",
                        "law_ref": "《消费者权益保护法》第24条",
                    },
                    {
                        "id": "ret_consumer_03",
                        "question": "促销活动是否合规？",
            ...
            },
            {
                ...
                "items": [
                    {
                        "id": "ret_data_01",
                        "question": "收集用户数据是否获得明确同意？",
                        "risk_level": "high",
                        "law_ref": "《个人信息保护法》第13条",
                    },
                    {
                        "id": "ret_data_02",
                        "question": "是否制定了隐私政策并公示？",
                        "risk_level": "high",
                        "law_ref": "《个人信息保护法》第17条",
                    },
                ],
            },
            {
        ...
        "industries": [
            {
                "id": k,
                "name": v["name"],
                "category_count": len(v["categories"]),
