...
from src.core.deps import get_current_user_required, require_permission, Permission, get_tenant_context, TenantContext
...
async def get_assistant_config(
    ...
    config = await service.get_or_create_config(user.org_id)
...
async def update_assistant_config(
    ...
    service = AIAssistantService(db)
    # 先获取现有配置
    existing = await service.get_or_create_config(user.org_id)
