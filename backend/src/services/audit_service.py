...
class AuditService:
    ...
    async def generate_compliance_report(
        ...
        for record in records:
            ...
            uid = str(record.user_id) if record.user_id else "system"
...
def audit_log(
    ...
    get_old_value: Callable[..., dict[str, Any]] | None = None,
    get_new_value: Callable[..., dict[str, Any]] | None = None,
