...
def build_response_a2ui(
    agent_name: str, content: str, user_query: str = ""
) -> dict[str, Any] | None:
    """
    ...
    try:
        ...
        return {"a2ui": {"components": components}}
...
def _extract_legal_references(content: str) -> list[str]:
    """提取法律法规引用"""
    refs: list[str] = []
...
def _extract_risk_items(content: str) -> list[str]:
    """提取风险提示项"""
    risks: list[str] = []
