...
class KnowledgeDocument(Base, TimestampMixin):
    ...
    source: Mapped[str | None] = mapped_column(String(255))  # 来源
    ...
    # 法律相关字段
    law_category: Mapped[str | None] = mapped_column(String(100))  # 法律类别
    effective_date: Mapped[str | None] = mapped_column(String(50))  # 生效日期
    issuing_authority: Mapped[str | None] = mapped_column(String(255))  # 发布机关
