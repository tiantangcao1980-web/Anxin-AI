...
class LLMConfig(Base, TimestampMixin):
    ...
    config_type: Mapped[str] = mapped_column(
        String(20), default="llm", comment="配置类型: llm/embedding/reranker"
    )
    ...
    api_base_url: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="API基础URL"
    )
    ...
    top_p: Mapped[float | None] = mapped_column(
        Float, default=1.0, nullable=True, comment="Top-P采样"
    )
    ...
    frequency_penalty: Mapped[float | None] = mapped_column(
        Float, default=0.0, nullable=True, comment="频率惩罚"
    )
    presence_penalty: Mapped[float | None] = mapped_column(
        Float, default=0.0, nullable=True, comment="存在惩罚"
    )

    # 本地模型参数
    local_endpoint: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="本地服务端点"
    )
    local_model_path: Mapped[str | None] = mapped_column(
        String(1000), nullable=True, comment="本地模型路径"
    )
    gpu_layers: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="GPU层数")
    context_length: Mapped[int | None] = mapped_column(
        Integer, default=4096, nullable=True, comment="上下文长度"
    )

    # 高级配置
    extra_params: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, default=dict, nullable=True, comment="额外参数"
    )
    headers: Mapped[dict[str, str] | None] = mapped_column(
        JSONB, default=dict, nullable=True, comment="自定义请求头"
    )
    ...
    total_calls: Mapped[int | None] = mapped_column(
        Integer, default=0, nullable=True, comment="总调用次数"
    )
    total_tokens: Mapped[int | None] = mapped_column(
        Integer, default=0, nullable=True, comment="总消耗token数"
    )
...
LLM_PROVIDER_CONFIGS = {
    ...
    "deepseek": {
        ...
        "models": {"llm": ["deepseek-chat", "deepseek-coder", "deepseek-reasoner"]},
        "supports_streaming": True,
        "api_key_required": True,
        "openai_compatible": True,
    },
    ...
    "minimax": {
        ...
        "models": {"llm": ["abab7-chat", "abab6.5s-chat", "abab6.5g-chat", "abab5.5s-chat"]},
        "supports_streaming": True,
        "api_key_required": True,
    ...
    "baichuan": {
        ...
        "models": {"llm": ["Baichuan4", "Baichuan3-Turbo", "Baichuan2-Turbo"]},
        "supports_streaming": True,
        "api_key_required": True,
        "openai_compatible": True,
    },
    "sparkdesk": {
        ...
        "models": {"llm": ["generalv3.5", "4.0Ultra"]},
        "supports_streaming": True,
        "api_key_required": True,
    ...
    "hunyuan": {
        ...
        "models": {"llm": ["hunyuan-pro", "hunyuan-standard", "hunyuan-lite"]},
        "supports_streaming": True,
        "api_key_required": True,
    ...
    "doubao": {
        ...
        "models": {"llm": ["doubao-pro-32k", "doubao-lite-32k", "doubao-pro-128k"]},
        "supports_streaming": True,
        "api_key_required": True,
        "openai_compatible": True,
    },
    "stepfun": {
        ...
        "models": {"llm": ["step-2-16k", "step-1-256k", "step-1-8k", "step-1v-32k"]},
        "supports_streaming": True,
        "api_key_required": True,
        "openai_compatible": True,
    },
    "yi": {
        ...
        "models": {"llm": ["yi-lightning", "yi-large", "yi-medium", "yi-vision"]},
        "supports_streaming": True,
        "api_key_required": True,
        "openai_compatible": True,
    },
    ...
    "localai": {
        ...
        "models": {"llm": ["gpt-3.5-turbo", "gpt-4"], "embedding": ["text-embedding-ada-002"]},
        "supports_streaming": True,
        "api_key_required": False,
        "is_local": True,
        "openai_compatible": True,
