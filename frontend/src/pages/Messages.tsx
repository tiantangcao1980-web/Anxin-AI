...
export default function Messages() {
 ...
 {/* WebSocket 连接状态 */}
 {!isConnected && (
 <div className="flex items-center justify-between px-4 py-1.5 bg-warning/10 border-b border-warning/20 text-warning text-xs shrink-0 -m-4 sm:-m-5 lg:-m-6 mb-0">
