...
function getNodeColor(type: string): string {
 return NODE_TYPE_COLORS[type] || graphNodeColors.other
}
...
export default function KnowledgeGraph() {
 ...
 className="p-1.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/20 transition-colors" title="清除图谱">
 ...
 <h3 className="text-lg font-medium text-foreground mb-2">探索知识图谱</h3>
 ...
 <div className="absolute top-4 right-4 z-10 bg-warning/10 border border-warning/20/30 text-warning rounded-lg px-3 py-2 text-xs flex items-center gap-2">
