      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        ...
        >
                ...
                {forgotStep === 'done' && (
                  <div className="text-center py-8">
                    <div className={`w-16 h-16 ${statusColor.success} ${radius.avatar} flex items-center justify-center mx-auto mb-4`}>
                      <icons.CheckCircle className={`${iconSize.xl} text-emerald-600 dark:text-emerald-400`} />
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="请再次输入密码"
                      className={`${inputCls}${regConfirm && regConfirm !== regPassword ? ' border-red-400 focus:ring-red-400/40' : ''}`}
                      autoComplete="new-password"
                    />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <svg className={iconSize.md} viewBox="0 0 24 24" fill="#07C160">
            ...
            <button
              ...
              className={`${buttonStyle.ghost} flex items-center justify-center gap-2 py-2.5 border border-border`}
            >
              <svg className={iconSize.md} viewBox="0 0 24 24" fill="#1677FF">
