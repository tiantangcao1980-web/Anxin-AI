...
'contract_reviewer': { icon: icons.FileSearch, color:'text-success', bgColor:'bg-success/10' },
...
'compliance_reviewer': { icon: icons.Shield, color:'text-success', bgColor:'bg-success/10' },
'compliance_officer': { icon: icons.Shield, color:'text-success', bgColor:'bg-success/10' },
'risk_assessor': { icon: icons.AlertTriangle, color:'text-warning', bgColor:'bg-warning/10' },
'litigation_strategist': { icon: icons.Gavel, color:'text-destructive', bgColor:'bg-destructive/10' },
...
export const AgentTaskBoard = memo(function AgentTaskBoard({
 ...
 <span className="text-sm font-medium text-foreground">多智能体协作</span>
 {levels.length > 1 && (
 ...
 <icons.Zap className="w-3 h-3 text-warning" />
 ...
 className="mt-3 rounded-xl border border-success/20 bg-success/10 p-4"
 >
 <div className="flex items-center gap-2 mb-3">
 <div className="w-6 h-6 rounded-lg bg-success/10 flex items-center justify-center">
 <icons.Sparkles className="w-3.5 h-3.5 text-success" />
 </div>
 <span className="text-sm font-medium text-foreground">协作完成</span>
 </div>
 ...
 <div className="text-center p-2 bg-background/70 rounded-lg">
 <p className="text-lg font-bold text-warning">{totalElapsed}s</p>
...
function TaskCard({
 ...
 completed:{ label:'已完成', dot:'bg-success', text:'text-success',border:'border-success/20',bg:'bg-success/10' },
 ...
 <p className="text-xs font-medium text-foreground truncate">{task.agent}</p>
 </div>
 ...
 <icons.CheckCircle className="w-3 h-3 text-success flex-shrink-0 mt-0.5" />
 <p className="text-[10px] text-success leading-relaxed line-clamp-1">{task.result}</p>
 </div>
 )}
 {task.status ==='failed' && (
