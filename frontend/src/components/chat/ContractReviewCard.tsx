...
export function ContractReviewCard() {
  ...
  const getRiskColor = (level: string) => {
    switch (level.toLowerCase()) {
      ...
      case 'medium': return 'bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800';
      case 'low': return 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800';
  ...
  const getRiskIcon = (level: string) => {
    switch (level.toLowerCase()) {
      ...
      case 'medium': return <icons.AlertTriangle className="w-4 h-4 text-amber-500" />;
      case 'low': return <icons.CheckCircle className="w-4 h-4 text-emerald-600" />;
            ...
            <div data-review-summary className="flex items-start gap-3 p-3 bg-muted rounded-xl">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-sm font-semibold text-foreground">审查概览</span>
              ...
              <div className="h-2 bg-muted rounded-full overflow-hidden">
                <motion.div
                  ...
                  className={`h-full rounded-full ${
                    ...
                    result.risk_score > 0.3 ? 'bg-amber-500' : 'bg-emerald-500'
                  }`}
                />
              </div>
            </div>
