...
'合同审查Agent': { icon: icons.FileSearch, color:'bg-success/10 text-success' },
...
'合规审查Agent': { icon: icons.Shield, color:'bg-success/10 text-success' },
'风险评估Agent': { icon: icons.AlertTriangle, color:'bg-warning/10 text-warning' },
'诉讼策略Agent': { icon: icons.Gavel, color:'bg-destructive/10 text-destructive' },
