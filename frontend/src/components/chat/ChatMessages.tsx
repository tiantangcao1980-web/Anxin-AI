                ...
                <div className="flex items-center gap-0.5">
                  <button
                    ...
                    className={`p-1 rounded-md hover:bg-muted transition-colors ${
                      message.feedback === 'up' ? 'text-emerald-600' : 'text-muted-foreground hover:text-emerald-600'
                    }`}
                    title="有帮助"
                  >
                  ...
                  <button
                    ...
                    disabled={!!message.feedback}
                    className={`p-1 rounded-md hover:bg-muted transition-colors ${
                      message.feedback === 'down' ? 'text-red-500' : 'text-muted-foreground hover:text-red-500'
                    }`}
                    title="需改进"
                  >
