...
const phaseConfig: Record<string, { label: string; icon: React.ElementType; iconColor: string; badgeColor: string }> = {
  requirement: {
    label: '需求分析',
    icon: icons.Target,
    iconColor: 'text-amber-500 bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-800',
    badgeColor: 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800',
  },
  planning: {
    label: '任务规划',
    icon: icons.Layers,
  ...
  result: {
    ...
    iconColor: 'text-emerald-500 bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800',
    badgeColor: 'text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800',
  },
};
