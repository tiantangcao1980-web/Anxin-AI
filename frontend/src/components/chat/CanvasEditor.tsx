...
'h-full flex flex-col bg-background',
 ...
 className={cn(
'flex-1 min-w-0 text-sm font-medium bg-transparent border-none outline-none truncate transition-colors',
 isEditingTitle
...
'text-[10px] flex items-center gap-1 px-1.5 py-0.5 rounded-full',
 ...
 className="p-1 rounded-md text-muted-foreground hover:text-success hover:bg-success/20 transition-colors flex-shrink-0"
 title="保存到文档库"
 >
...
'p-1 rounded-md flex-shrink-0',
 ...
 className="flex items-center gap-1 px-2 py-1 bg-warning/10 dark:bg-warning/30 text-warning rounded-md border border-yellow-200 dark:border-yellow-800 text-xs hover:bg-warning dark:hover:bg-warning/30 flex-shrink-0"
 >
