...
export default function AnonymousChatRoom({ roomId, token, role, onClose }: AnonymousChatRoomProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              <span className={`inline-block w-1.5 h-1.5 rounded-full ${connected ? 'bg-emerald-500' : 'bg-muted-foreground/30'}`} />
      ...
      {/* 身份揭示成功横幅 */}
      {revealed && (
        <div className="mx-4 mt-3 p-3 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-xl">
          <div className="flex items-center gap-2 mb-1.5">
            <icons.CheckCircle className={`${iconSize.sm} text-emerald-600 dark:text-emerald-400`} />
            <span className="text-sm font-medium text-emerald-700 dark:text-emerald-300">身份已揭示</span>
          </div>
