...
export const InlineSuggestion = memo(function InlineSuggestion({
 ...
 exit={{ opacity: 0, x: 10 }}
 className="border-l-2 border-warning/20 bg-warning/10/50 rounded-r-lg p-3 my-1"
 >
 {/* 原文 */}
 <div className="text-xs">
 <span className="text-muted-foreground font-medium">原文：</span>
 <span className="text-destructive line-through ml-1">{suggestion.original}</span>
 </div>
