  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 border-b border-border bg-background">
      ...
      <input
        ...
        className="text-sm font-bold text-foreground bg-transparent border-none outline-none flex-shrink-0 max-w-[200px] truncate focus:ring-0"
        placeholder="文档标题"
      />
      ...
      {hasSuggestions && (
        <button
          onClick={onAcceptAll}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-950/50 transition-colors border border-emerald-200 dark:border-emerald-800"
        >
      ...
      {onInitiateSigning && (
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-950/50 transition-colors border border-emerald-200 dark:border-emerald-800"
          title="发起签约/盖章流程"
        >
      ...
      {/* 保存状态指示 */}
      <span className={`text-[10px] flex items-center gap-1 ${isSaved ? 'text-emerald-600' : 'text-amber-500'}`}>
