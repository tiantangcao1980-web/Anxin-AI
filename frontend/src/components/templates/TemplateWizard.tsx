  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-muted/30">
        <div>
          <h2 className="text-lg font-semibold text-foreground">{template.name.replace(/\{\{.*?\}\}/g, '')}</h2>
          ...
          <div className="mt-8 flex gap-3">
            ...
            {showPreview && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all text-sm font-medium"
              >
            ...
            >
              <div className="h-full overflow-y-auto p-6 bg-muted/20">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-semibold text-foreground">合同预览</h3>
                  <button
                    onClick={() => {
