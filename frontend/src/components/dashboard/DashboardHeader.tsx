...
export function DashboardHeader() {
 ...
 { label:'知识库资源', value: (knowledgeResp.total || 0).toString(), unit:'个库', icon: icons.Brain, lottie:'thinking', color:'text-warning', bgColor:'bg-warning/10' },
 { label:'自我进化次数', value:'--', unit:'次迭代', icon: icons.Activity, lottie:'success', color:'text-success', bgColor:'bg-success/10' },
 ]);
 } catch {
 setStats([
 ...
 { label:'知识库资源', value:'--', unit:'个库', icon: icons.Brain, lottie:'thinking', color:'text-warning', bgColor:'bg-warning/10' },
 { label:'自我进化次数', value:'--', unit:'次迭代', icon: icons.Activity, lottie:'success', color:'text-success', bgColor:'bg-success/10' },
 ]);
 }
 } finally {
 ...
 <span className="text-[10px] font-medium px-2.5 py-1 rounded-full bg-muted/50 text-muted-foreground border border-border">
 实时
 </span>
 </div>
