  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 bg-amber-50 dark:bg-amber-950/30 rounded-xl flex items-center justify-center">
          <icons.Zap className="w-4 h-4 text-amber-600 dark:text-amber-400" />
        </div>
        <div>
