...
export function ExperienceMemory() {
 ...
 if (rating >= 1) return'text-destructive'
 ...
 className="w-full pl-9 pr-3 py-2.5 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-warning/20/20 focus:border-warning/20 text-sm"
 />
 </div>
 <button
 ...
 <icons.Brain className="w-3.5 h-3.5 text-warning flex-shrink-0" />
 ...
 <icons.Brain className="w-8 h-8 text-warning" />
 </div>
 <p className="text-muted-foreground font-medium">暂无经验记忆</p>
 ...
 <icons.Brain className="w-4 h-4 text-warning" />
 ...
 {/* 任务描述 */}
 <div>
 <label className="text-xs font-medium text-muted-foreground uppercase tracking-caption">任务描述</label>
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground uppercase tracking-caption">结果摘要</label>
 ...
 <div>
 <label className="text-xs font-medium text-muted-foreground uppercase tracking-caption">
 ...
 <span className="flex-shrink-0 w-5 h-5 rounded-full bg-warning/10 text-warning flex items-center justify-center text-[10px] font-bold">
 {i + 1}
 </span>
 ...
 {/* 评分 */}
 <div>
 <label className="text-xs font-medium text-muted-foreground uppercase tracking-caption mb-2 block">
 你的评价 (对系统处理质量打分)
 </label>
 ...
 <icons.Star
 className={`w-7 h-7 ${
 star <= feedbackRating ?'text-warning' :'text-muted-foreground/30'
 }`}
 ...
 {/* 评论 */}
 <div>
 <label className="text-xs font-medium text-muted-foreground uppercase tracking-caption mb-1 block">
 评价内容（可选）
 </label>
 <textarea
 ...
 className="w-full px-3 py-2 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-warning/20/20 resize-none h-20"
 />
 </div>
 </div>
...
export function EvolutionEngine() {
 ...
 {/* 自进化控制面板 */}
 <div className="bg-gradient-to-br from-success via-white to-teal-50 rounded-2xl border border-success/20 overflow-hidden">
 <div className="p-6">
 ...
 <div key={i} className="bg-background/70 backdrop-blur-sm rounded-xl border border-success/20 p-4 relative">
 {i < 3 && (
 <div className="hidden md:block absolute top-1/2 -right-2 w-4 text-success">
 <icons.ChevronRight className="w-4 h-4" />
 </div>
 )}
 <step.icon className="w-5 h-5 text-success mb-2" />
 ...
 <span className="font-medium text-sm text-primary">用户反馈采集</span>
 </div>
 <p className="text-xs text-primary/80">
 每次AI处理完法律任务后，用户可以对结果进行1-5星评价，系统自动记录到经验记忆库。
 </p>
 <div className="mt-3 flex items-center gap-1.5">
 <icons.CheckCircle2 className="w-3.5 h-3.5 text-success" />
 <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded-md ${statusBadge.success}`}>已激活</span>
 </div>
 </div>
 <div className="bg-warning/10 rounded-xl p-4 border border-warning/20">
 <div className="flex items-center gap-2 mb-2">
 <icons.BarChart3 className="w-4 h-4 text-warning" />
 <span className="font-medium text-sm text-warning">经验加权排序</span>
 </div>
 ...
 <span className="font-medium text-sm text-primary">决策优化</span>
 </div>
 <p className="text-xs text-primary/80">
 ...
 <div className="text-2xl font-bold text-success">{status.high_rated_count}</div>
 <div className="text-xs text-success mt-1 font-medium">优质 (4-5星)</div>
 <div className="flex justify-center mt-1.5">
 {[1,2,3,4,5].map(s => (
 <icons.Star key={s} className="w-3 h-3 text-success" fill={s <= 4 ?'currentColor' :'none'} />
 ))}
 </div>
 </div>
