...
const KB_TYPE_CONFIG: Record<string, { label: string; icon: any; color: string }> = {
  ...
  case: { label: '司法判例', icon: icons.Briefcase, color: 'text-amber-600 bg-amber-50' },
  interpretation: { label: '司法解释', icon: icons.BookOpen, color: 'text-emerald-600 bg-emerald-50' },
                ...
                >
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-semibold text-sm text-foreground truncate">{kb.name}</div>
        ...
        {selectedKb ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center space-y-4">
              ...
              <div>
                <p className="text-muted-foreground font-semibold">选择一个知识库</p>
