...
export function SmartSearch() {
  ...
  const modeConfig = {
    ...
    rag: { label: 'RAG问答', icon: icons.MessageSquare, color: 'bg-emerald-600 hover:bg-emerald-700' },
      ...
      <div className="p-6 bg-background border-b border-border">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">智慧搜索引擎</h2>
                ...
                <div className="p-6">
                  ...
                  {ragAnswer.sources?.length > 0 && (
                    <div className="mt-6 pt-4 border-t border-border">
                      <h5 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">参考来源</h5>
          ...
          <div className="space-y-3">
            {loading ? (
              ...
              results.map((item, index) => (
                ...
                >
                  {item.metadata?.keyword_match && (
                    <div className="absolute top-0 right-0 px-2 py-0.5 bg-primary text-[10px] text-primary-foreground font-bold rounded-bl-lg">
                      精准匹配
                    </div>
                  )}
              ...
              <div className="py-24 text-center space-y-4">
                ...
                <div>
                  <p className="text-muted-foreground font-semibold">探索法律知识宇宙</p>
