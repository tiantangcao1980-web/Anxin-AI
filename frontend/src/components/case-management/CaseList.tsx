...
'under-review': { label:'审核中', badge: statusBadge.warning },
 ...
 high: { border:'border-warning/20', dot:'bg-warning' },
 urgent: { border:'border-destructive/30', dot:'bg-destructive' },
 };

 return (
 <div className="h-full flex flex-col bg-background">
 <div data-ui="page-header" className="border-b border-border bg-surface-1 px-5 pt-3 pb-3">
 {/* 统计 + 操作（标题已由外层 CaseCenter Tab 承担，不再重复） */}
 <div className="flex items-center justify-between mb-3">
 <p className={heading.muted}>共 {cases.length} 个案件</p>
 <button
