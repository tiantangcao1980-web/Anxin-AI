...
export function InvestigationOverview({ data, companyName, onNavigate, onGenerateReport }: InvestigationOverviewProps) {
 ...
 const riskConfig = {
 high: { label:'高风险', color:'text-destructive', bg:'bg-destructive/10', border:'border-destructive/20' },
 medium: { label:'中风险', color:'text-warning', bg:'bg-warning/10', border:'border-warning/20' },
 low: { label:'低风险', color:'text-success', bg:'bg-success/10', border:'border-success/20' },
 }
 ...
 const dataQualityColor = dataQuality ==='real' ?'text-success bg-success/10' : dataQuality ==='public' ?'text-primary bg-primary/5' :'text-muted-foreground bg-muted'
