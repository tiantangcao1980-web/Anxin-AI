...
const DIFF_STYLES: Record<DiffType, string> = {
 added:'bg-success/10 text-success border-l-2 border-success/20 pl-2',
 removed:'bg-destructive/10 text-destructive line-through opacity-60 border-l-2 border-destructive/20 pl-2',
 modified:'bg-warning/10 text-warning border-l-2 border-warning/20 pl-2',
};
