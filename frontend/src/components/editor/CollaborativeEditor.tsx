      ...
      >
        <div className="flex flex-col items-center">
          ...
          <div className="w-4 h-0.5 rounded-full mt-0.5" style={{
            backgroundColor: type === 'text' ? (editor?.getAttributes('textStyle')?.color || '#000') : '#FFEAA7'
          }} />
        </div>
      </ToolbarButton>
      {open && (
              ...
              {editor && (
                <EditorContent
                  ...
                  className={cn(
                    ...
                    '[&_.ProseMirror_h1]:text-center [&_.ProseMirror_h1]:text-xl [&_.ProseMirror_h1]:font-bold [&_.ProseMirror_h1]:mb-6',
                    '[&_.ProseMirror_h2]:text-base [&_.ProseMirror_h2]:font-bold [&_.ProseMirror_h2]:mt-6 [&_.ProseMirror_h2]:mb-3',
                    '[&_.ProseMirror_h3]:text-sm [&_.ProseMirror_h3]:font-bold [&_.ProseMirror_h3]:mt-4 [&_.ProseMirror_h3]:mb-2',
