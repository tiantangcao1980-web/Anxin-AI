...
const MODE_ICONS = {
'top-secret': { icon: ShieldCheckIcon, color:'text-destructive', label:'绝密' },
 hybrid: { icon: ArrowPathIcon, color:'text-warning', label:'混合' },
 cloud: { icon: CloudIcon, color:'text-info', label:'云端' },
} as const
