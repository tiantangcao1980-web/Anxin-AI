...
import { complianceScoreColors } from'@/lib/design-tokens';

export function ProgressTracker() {
 const stats = [
 { label:'文书质量分', value:'78', max: 100, icon: icons.Award, color:'hsl(var(--primary))', bg:'bg-primary/5' },
 { label:'合规率', value:'85', max: 100, icon: icons.Target, color: complianceScoreColors.excellent, bg:'bg-success/10 dark:bg-success/20' },
 ...
 <h3 className="font-medium text-foreground text-sm lg:text-base">成长追踪</h3>
