    ...
    <div className="flex flex-col h-full bg-background border-l border-border w-80">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold">AI 法律助手</span>
          {listening && (
      ...
      <div className="px-4 py-3 border-b border-border">
        {!listening ? (
          ...
          <button
            onClick={handleStop}
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-red-50 text-red-600 border border-red-200 rounded-lg text-sm font-medium hover:bg-red-100 disabled:opacity-50"
          >
