...
'success-check': (
 ...
 className="w-3/4 h-3/4 rounded-full bg-success flex items-center justify-center"
 >
 <svg
...
'error-x': (
 ...
 animate={{ scale: 1 }}
 transition={{ type:'spring', stiffness: 200, damping: 10 }}
 className="w-3/4 h-3/4 rounded-full bg-destructive flex items-center justify-center"
 >
 <svg
 className="w-1/2 h-1/2 text-white"
 fill="none"
