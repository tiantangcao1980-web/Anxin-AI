...
const stepStatusConfig = {
 ...
 completed: { icon: icons.Check, color:'text-success', bg:'bg-success/10', line:'bg-success' },
 error: { icon: icons.AlertCircle, color:'text-destructive', bg:'bg-destructive/10', line:'bg-destructive' },
