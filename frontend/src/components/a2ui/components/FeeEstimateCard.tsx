  ...
  return (
    <div className={cn(
              ...
              >
                ...
                <div className="flex flex-wrap gap-1 mt-2">
                  {pkg.features.map((f, i) => (
                    <span key={i} className="inline-flex items-center gap-0.5 text-[10px] text-emerald-700 dark:text-emerald-400">
      ...
      {data.notes && data.notes.length > 0 && (
        <div className="px-4 py-2 bg-amber-50/50 dark:bg-amber-950/30 border-t border-border">
