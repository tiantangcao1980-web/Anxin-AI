...
export default function TemplateListCard({
 ...
 return (
 <Card className="border-info/20 bg-info/10/50 mt-4">
 ...
 return (
 <Card className="border-info/20 bg-gradient-to-br from-info to-indigo-50 dark:to-indigo-900/20 mt-4">
 <CardHeader className="pb-2">
 <CardTitle className="text-base flex items-center gap-2">
 <icons.FileText className="h-5 w-5 text-info" />
