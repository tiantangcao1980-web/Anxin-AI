...
const riskLevelConfig = {
  low: { label: '低风险', color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-900/20', icon: icons.CheckCircle },
  medium: { label: '中风险', color: 'text-amber-600', bg: 'bg-amber-50 dark:bg-amber-900/20', icon: icons.Info },
  high: { label: '高风险', color: 'text-red-600', bg: 'bg-red-50 dark:bg-red-900/20', icon: icons.AlertTriangle },
};
