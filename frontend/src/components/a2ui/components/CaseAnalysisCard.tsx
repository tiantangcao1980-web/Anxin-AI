...
const getProbabilityConfig = (probability: number) => {
  if (probability >= 70) return { color: 'bg-emerald-500', text: 'text-emerald-600 dark:text-emerald-400', label: '较高' };
  if (probability >= 40) return { color: 'bg-amber-500', text: 'text-amber-600 dark:text-amber-400', label: '中等' };
  return { color: 'bg-red-500', text: 'text-red-600 dark:text-red-400', label: '较低' };
};
