    ...
    <div className="h-full overflow-y-auto p-4 lg:p-6 bg-muted">
      <div className="max-w-4xl mx-auto">
        ...
        {step === 3 && !isGenerating && (
          ...
          >
            <div className="text-center mb-6 lg:mb-8">
              <div className="w-14 h-14 lg:w-16 lg:h-16 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-4">
                <icons.CheckCircle className="w-7 h-7 lg:w-8 lg:h-8 text-emerald-600" />
              </div>
              <h3 className="text-lg lg:text-xl font-semibold text-foreground mb-2">
                生成完成！
              </h3>
